...
const YrEmployeeKPIRateRangeLayout = (props) => {
    ...
    const menu = [
        {
            label: 'YrEmployeeKPIRateRange Mgmt',
            items: [
...
const mapState = (state) => {
    ...
    const { selectedYrEmployeeKPIRateRange } = state.yrEmployeeKPIRateRange;
    const { menuOpen } = state.layout;
    return { user, isLoggedIn, selectedYrEmployeeKPIRateRange, menuOpen };
  };
  const mapDispatch = (dispatch) => ({
    setMenuOpen: (bool) => dispatch.layout.setMenuOpen(bool),
    getOneYrEmployeeKPIRateRange: (id) => dispatch.yrEmployeeKPIRateRange.getOneYrEmployeeKPIRateRange(id),
  });

export default connect(mapState, mapDispatch)(YrEmployeeKPIRateRangeLayout);
