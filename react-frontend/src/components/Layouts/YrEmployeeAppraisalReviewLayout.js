...
const YrEmployeeAppraisalReviewLayout = (props) => {
    ...
    const menu = [
        {
            label: 'YrEmployeeAppraisalReview Mgmt',
            items: [
...
const mapState = (state) => {
    ...
    const { selectedYrEmployeeAppraisalReview } = state.yrEmployeeAppraisalReview;
    const { menuOpen } = state.layout;
    return { user, isLoggedIn, selectedYrEmployeeAppraisalReview, menuOpen };
  };
  const mapDispatch = (dispatch) => ({
    setMenuOpen: (bool) => dispatch.layout.setMenuOpen(bool),
    getOneYrEmployeeAppraisalReview: (id) => dispatch.yrEmployeeAppraisalReview.getOneYrEmployeeAppraisalReview(id),
  });

export default connect(mapState, mapDispatch)(YrEmployeeAppraisalReviewLayout);
