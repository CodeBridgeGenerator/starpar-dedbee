...
const YrEmployeeAppraisalRemarkLayout = (props) => {
    ...
    const menu = [
        {
            label: 'YrEmployeeAppraisalRemarks Mgmt',
            items: [
...
const mapState = (state) => {
    ...
    const { selectedYrEmployeeAppraisalRemark } = state.yrEmployeeAppraisalRemark;
    const { menuOpen } = state.layout;
    return { user, isLoggedIn, selectedYrEmployeeAppraisalRemark, menuOpen };
  };
  const mapDispatch = (dispatch) => ({
    setMenuOpen: (bool) => dispatch.layout.setMenuOpen(bool),
    getOneYrEmployeeAppraisalRemark: (id) => dispatch.yrEmployeeAppraisalRemark.getOneYrEmployeeAppraisalRemark(id),
  });

export default connect(mapState, mapDispatch)(YrEmployeeAppraisalRemarkLayout);
