...
const EmployeeAppraisalReviewLayout = (props) => {
    ...
    const menu = [
        {
            label: 'EmployeeAppraisalReview Mgmt',
            items: [
...
const mapState = (state) => {
    ...
    const { selectedEmployeeAppraisalReview } = state.employeeAppraisalReview;
    const { menuOpen } = state.layout;
    return { user, isLoggedIn, selectedEmployeeAppraisalReview, menuOpen };
  };
  const mapDispatch = (dispatch) => ({
    setMenuOpen: (bool) => dispatch.layout.setMenuOpen(bool),
    getOneEmployeeAppraisalReview: (id) => dispatch.employeeAppraisalReview.getOneEmployeeAppraisalReview(id),
  });

export default connect(mapState, mapDispatch)(EmployeeAppraisalReviewLayout);
