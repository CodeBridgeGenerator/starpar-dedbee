...
const EmployeeCompetenciesscoreLayout = (props) => {
    ...
    const menu = [
        {
            label: 'EmployeeCompetenciesscore Mgmt',
            items: [
...
const mapState = (state) => {
    ...
    const { selectedEmployeeCompetenciesscore } = state.employeeCompetenciesscore;
    const { menuOpen } = state.layout;
    return { user, isLoggedIn, selectedEmployeeCompetenciesscore, menuOpen };
  };
  const mapDispatch = (dispatch) => ({
    setMenuOpen: (bool) => dispatch.layout.setMenuOpen(bool),
    getOneEmployeeCompetenciesscore: (id) => dispatch.employeeCompetenciesscore.getOneEmployeeCompetenciesscore(id),
  });

export default connect(mapState, mapDispatch)(EmployeeCompetenciesscoreLayout);
