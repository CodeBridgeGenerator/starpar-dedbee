...
const YrEmployeeCompetenciesscoreLayout = (props) => {
    ...
    const menu = [
        {
            label: 'YrEmployeeCompetenciesscore Mgmt',
            items: [
...
const mapState = (state) => {
    ...
    const { selectedYrEmployeeCompetenciesscore } = state.yrEmployeeCompetenciesscore;
    const { menuOpen } = state.layout;
    return { user, isLoggedIn, selectedYrEmployeeCompetenciesscore, menuOpen };
  };
  const mapDispatch = (dispatch) => ({
    setMenuOpen: (bool) => dispatch.layout.setMenuOpen(bool),
    getOneYrEmployeeCompetenciesscore: (id) => dispatch.yrEmployeeCompetenciesscore.getOneYrEmployeeCompetenciesscore(id),
  });

export default connect(mapState, mapDispatch)(YrEmployeeCompetenciesscoreLayout);
