...
const EmployeeAppraisalRemarkLayout = (props) => {
    ...
    const menu = [
        {
            label: 'EmployeeAppraisalRemarks Mgmt',
            items: [
...
const mapState = (state) => {
    ...
    const { selectedEmployeeAppraisalRemark } = state.employeeAppraisalRemark;
    const { menuOpen } = state.layout;
    return { user, isLoggedIn, selectedEmployeeAppraisalRemark, menuOpen };
  };
  const mapDispatch = (dispatch) => ({
    setMenuOpen: (bool) => dispatch.layout.setMenuOpen(bool),
    getOneEmployeeAppraisalRemark: (id) => dispatch.employeeAppraisalRemark.getOneEmployeeAppraisalRemark(id),
  });

export default connect(mapState, mapDispatch)(EmployeeAppraisalRemarkLayout);
