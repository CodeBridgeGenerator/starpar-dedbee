...
import seederData from "./appraisals.seeder.json";
...
const AppraisalsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(AppraisalsSeederDialogComponent);
