...
const AppraisalsEditDialogComponent = (props) => {
...
employeeNo: _entity?.employeeNo?._id,
fYear: _entity?.fYear,
...
demeritScore: _entity?.demeritScore,
totalScore: _entity?.totalScore,
finalScore: _entity?.finalScore,
empComment: _entity?.empComment,
mngComment: _entity?.mngComment,
mngSuperiorComment: _entity?.mngSuperiorComment,
managerEmpNo: _entity?.managerEmpNo?._id,
kraWeight: _entity?.kraWeight,
competencyWeight: _entity?.competencyWeight,
        ...
        await client.service("appraisals").patch(_entity._id, _data);
        ...
        props.onHide();
        props.alert({ type: "success", title: "Edit info", message: "Info appraisals updated successfully" });
...
const managerEmpNoOptions = managerEmpNo.map((elem) => ({ name: elem.name, value: elem.value }));
    ...
    return (
        <Dialog header="Edit Appraisals" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max scalein animation-ease-in-out animation-duration-1000" footer={renderFooter()} resizable={false}>
            <div className="grid p-fluid overflow-y-auto"
            style={{ maxWidth: "55vw" }} role="appraisals-edit-dialog-component">
                <div className="col-12 md:col-6 field">
            <span className="align-items-center">
                <label htmlFor="appraisalId">AppraisalID:</label>
                <InputNumber id="appraisalId" className="w-full mb-3 p-inputtext-sm" value={_entity?.appraisalId} onChange={(e) => setValByKey("appraisalId", e.value)}  useGrouping={false}/>
            </span>
...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <InputNumber id="fYear" className="w-full mb-3 p-inputtext-sm" value={_entity?.fYear} onChange={(e) => setValByKey("fYear", e.value)}  useGrouping={false}/>
            </span>
            <small className="p-error">
...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <InputNumber id="demeritScore" className="w-full mb-3 p-inputtext-sm" value={_entity?.demeritScore} onChange={(e) => setValByKey("demeritScore", e.value)}  useGrouping={false}/>
            </span>
            <small className="p-error">
...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <InputNumber id="finalScore" className="w-full mb-3 p-inputtext-sm" value={_entity?.finalScore} onChange={(e) => setValByKey("finalScore", e.value)}  useGrouping={false}/>
            </span>
            <small className="p-error">
...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <InputNumber id="kraWeight" className="w-full mb-3 p-inputtext-sm" value={_entity?.kraWeight} onChange={(e) => setValByKey("kraWeight", e.value)}  useGrouping={false}/>
            </span>
            <small className="p-error">
...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <InputNumber id="competencyWeight" className="w-full mb-3 p-inputtext-sm" value={_entity?.competencyWeight} onChange={(e) => setValByKey("competencyWeight", e.value)}  useGrouping={false}/>
            </span>
            <small className="p-error">
...
export default connect(mapState, mapDispatch)(AppraisalsEditDialogComponent);
