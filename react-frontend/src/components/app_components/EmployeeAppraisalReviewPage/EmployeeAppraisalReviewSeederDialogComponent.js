...
import seederData from "./employeeAppraisalReview.seeder.json";
...
const EmployeeAppraisalReviewSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(EmployeeAppraisalReviewSeederDialogComponent);
