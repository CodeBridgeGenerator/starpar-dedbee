...
import seederData from "./parSessionAppraisers.seeder.json";
...
const ParSessionAppraisersSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(ParSessionAppraisersSeederDialogComponent);
