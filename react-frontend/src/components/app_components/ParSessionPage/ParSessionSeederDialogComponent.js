...
import seederData from "./parSession.seeder.json";
...
const ParSessionSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(ParSessionSeederDialogComponent);
