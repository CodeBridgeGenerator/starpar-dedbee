...
import seederData from "./masterKpi.seeder.json";
...
const MasterKpiSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(MasterKpiSeederDialogComponent);
