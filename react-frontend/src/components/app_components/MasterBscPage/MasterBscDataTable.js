...
const MasterBscDataTable = ({ items, fields, onEditRow, onRowDelete, onRowClick, searchDialog, setSearchDialog,   showUpload, setShowUpload,
...
const pTemplate0 = (rowData, { rowIndex }) => <p >{rowData.code}</p>
const pTemplate1 = (rowData, { rowIndex }) => <p >{rowData.name}</p>
  ...
  const handleHideDialog = () => {
    ...
    return (
        ...
        />
<Column field="code" header="Code" body={pTemplate0} filter={selectedFilterFields.includes("code")} hidden={selectedHideFields?.includes("code")}  sortable style={{ minWidth: "8rem" }} />
<Column field="name" header="Name" body={pTemplate1} filter={selectedFilterFields.includes("name")} hidden={selectedHideFields?.includes("name")}  sortable style={{ minWidth: "8rem" }} />
      ...
      {selectedItems.length > 0 ? (
        ...
        <Dialog header="Upload MasterBsc Data" visible={showUpload} onHide={() => setShowUpload(false)}>
        <UploadService 
          user={user} 
          serviceName="masterBsc"            
          onUploadComplete={() => {
            setShowUpload(false); // Close the dialog after upload
          }}/>
      </Dialog>

      <Dialog header="Search MasterBsc" visible={searchDialog} onHide={() => setSearchDialog(false)}>
      Search
    </Dialog>
    <Dialog
        header="Filter Users"
...
export default MasterBscDataTable;