...
import seederData from "./masterBsc.seeder.json";
...
const MasterBscSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(MasterBscSeederDialogComponent);
