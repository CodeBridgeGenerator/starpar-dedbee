...
import seederData from "./masterKra.seeder.json";
...
const MasterKraSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(MasterKraSeederDialogComponent);
