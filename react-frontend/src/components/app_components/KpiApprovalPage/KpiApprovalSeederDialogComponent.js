...
import seederData from "./kpiApproval.seeder.json";
...
const KpiApprovalSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(KpiApprovalSeederDialogComponent);
