...
import seederData from "./masterCompetencies.seeder.json";
...
const MasterCompetenciesSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(MasterCompetenciesSeederDialogComponent);
