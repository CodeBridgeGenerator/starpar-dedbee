...
import seederData from "./yrEmployeeAppraisalRemarks.seeder.json";
...
const YrEmployeeAppraisalRemarksSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(YrEmployeeAppraisalRemarksSeederDialogComponent);
