...
import seederData from "./accessControl.seeder.json";
...
const AccessControlSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(AccessControlSeederDialogComponent);
