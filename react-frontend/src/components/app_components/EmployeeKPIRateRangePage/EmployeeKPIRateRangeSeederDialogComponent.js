...
import seederData from "./employeeKPIRateRange.seeder.json";
...
const EmployeeKPIRateRangeSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(EmployeeKPIRateRangeSeederDialogComponent);
