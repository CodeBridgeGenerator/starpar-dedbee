...
import seederData from "./yrEmployeeCompetenciesscore.seeder.json";
...
const YrEmployeeCompetenciesscoreSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(YrEmployeeCompetenciesscoreSeederDialogComponent);
