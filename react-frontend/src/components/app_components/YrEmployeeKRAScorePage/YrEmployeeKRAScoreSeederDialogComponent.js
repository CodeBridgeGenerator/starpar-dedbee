...
import seederData from "./yrEmployeeKRAScore.seeder.json";
...
const YrEmployeeKRAScoreSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(YrEmployeeKRAScoreSeederDialogComponent);
