...
import seederData from "./yrEmployeeTraining.seeder.json";
...
const YrEmployeeTrainingSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(YrEmployeeTrainingSeederDialogComponent);
