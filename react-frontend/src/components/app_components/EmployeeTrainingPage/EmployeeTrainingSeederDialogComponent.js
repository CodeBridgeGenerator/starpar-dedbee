...
import seederData from "./employeeTraining.seeder.json";
...
const EmployeeTrainingSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(EmployeeTrainingSeederDialogComponent);
