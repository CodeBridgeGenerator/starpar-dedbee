...
import seederData from "./masterTraining.seeder.json";
...
const MasterTrainingSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(MasterTrainingSeederDialogComponent);
