...
import seederData from "./rateReview.seeder.json";
...
const RateReviewSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(RateReviewSeederDialogComponent);
