    ...
    useEffect(() => {
        ...
        client
            ...
            .catch((error) => {
                ...
                setLoading(false);
                props.hide();
                props.alert({ title: "Employee Competenciesscore", type: "error", message: error.message || "Failed get Employee Competenciesscore" });
            });
  ...
  const onClickSaveHiddenfields = (ff) => {
    ...
    const deleteRow = async () => {
        try {
            ...
            console.log({ error });
            props.alert({ title: "Employee Competenciesscore", type: "error", message: error.message || "Failed delete record" });
        }
    };
      ...
      props.show();
        ...
        await Promise.all(
          promises.map((p) =>
            p.catch((error) => {
              props.alert({
                title: "Employee Competenciesscore",
                type: "error",
            ...
            <div className="grid">
                <div className="col-6 flex align-items-center justify-content-start">
                    <h4 className="mb-0 ml-2">
                        <span> My App /{" "}</span>
                        <strong>Employee Competenciesscore </strong>
                    </h4>
                    <SplitButton
