...
import seederData from "./employeeCompetenciesscore.seeder.json";
...
const EmployeeCompetenciesscoreSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(EmployeeCompetenciesscoreSeederDialogComponent);
