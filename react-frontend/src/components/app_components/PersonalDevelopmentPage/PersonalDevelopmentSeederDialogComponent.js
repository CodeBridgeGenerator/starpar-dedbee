...
import seederData from "./personalDevelopment.seeder.json";
...
const PersonalDevelopmentSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(PersonalDevelopmentSeederDialogComponent);
