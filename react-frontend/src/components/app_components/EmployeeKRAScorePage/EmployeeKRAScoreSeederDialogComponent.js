...
import seederData from "./employeeKRAScore.seeder.json";
...
const EmployeeKRAScoreSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(EmployeeKRAScoreSeederDialogComponent);
