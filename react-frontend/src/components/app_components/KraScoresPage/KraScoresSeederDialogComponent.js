...
import seederData from "./kraScores.seeder.json";
...
const KraScoresSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(KraScoresSeederDialogComponent);
