...
import seederData from "./scoreConfig.seeder.json";
...
const ScoreConfigSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(ScoreConfigSeederDialogComponent);
