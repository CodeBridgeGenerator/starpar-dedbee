...
import seederData from "./competenciesScores.seeder.json";
...
const CompetenciesScoresSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(CompetenciesScoresSeederDialogComponent);
