...
import seederData from "./employeeAppraisal.seeder.json";
...
const EmployeeAppraisalSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(EmployeeAppraisalSeederDialogComponent);
