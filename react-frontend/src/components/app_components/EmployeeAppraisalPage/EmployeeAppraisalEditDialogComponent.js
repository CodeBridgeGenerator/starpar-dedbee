...
const EmployeeAppraisalEditDialogComponent = (props) => {
...
competencyWeight: _entity?.competencyWeight,
        ...
        const result = await client.service("employeeAppraisal").patch(_entity._id, _data);
        props.onHide();
        props.alert({ type: "success", title: "Edit info", message: "Info employeeAppraisal updated successfully" });
    ...
    return (
        <Dialog header="Edit Employee Appraisal" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max scalein animation-ease-in-out animation-duration-1000" footer={renderFooter()} resizable={false}>
            <div className="grid p-fluid overflow-y-auto"
            style={{ maxWidth: "55vw" }} role="employeeAppraisal-edit-dialog-component">
...
export default connect(mapState, mapDispatch)(EmployeeAppraisalEditDialogComponent);
