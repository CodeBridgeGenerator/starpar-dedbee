...
import seederData from "./calibration.seeder.json";
...
const CalibrationSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(CalibrationSeederDialogComponent);
