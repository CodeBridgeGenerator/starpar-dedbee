...
const TotalScoreEditDialogComponent = (props) => {
...
weightedRate: _entity?.weightedRate,
        ...
        const result = await client.service("totalScore").patch(_entity._id, _data);
        props.onHide();
        props.alert({ type: "success", title: "Edit info", message: "Info totalScore updated successfully" });
    ...
    return (
        <Dialog header="Edit Total Score" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max scalein animation-ease-in-out animation-duration-1000" footer={renderFooter()} resizable={false}>
            <div className="grid p-fluid overflow-y-auto"
            style={{ maxWidth: "55vw" }} role="totalScore-edit-dialog-component">
...
export default connect(mapState, mapDispatch)(TotalScoreEditDialogComponent);
