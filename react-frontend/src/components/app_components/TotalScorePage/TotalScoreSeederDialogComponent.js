...
import seederData from "./totalScore.seeder.json";
...
const TotalScoreSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(TotalScoreSeederDialogComponent);
