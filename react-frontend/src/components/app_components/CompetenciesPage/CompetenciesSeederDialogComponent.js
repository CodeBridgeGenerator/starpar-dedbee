...
import seederData from "./competencies.seeder.json";
...
const CompetenciesSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(CompetenciesSeederDialogComponent);
