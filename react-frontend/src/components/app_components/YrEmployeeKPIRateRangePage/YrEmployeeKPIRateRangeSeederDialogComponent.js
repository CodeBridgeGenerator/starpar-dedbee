...
import seederData from "./yrEmployeeKPIRateRange.seeder.json";
...
const YrEmployeeKPIRateRangeSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(YrEmployeeKPIRateRangeSeederDialogComponent);
