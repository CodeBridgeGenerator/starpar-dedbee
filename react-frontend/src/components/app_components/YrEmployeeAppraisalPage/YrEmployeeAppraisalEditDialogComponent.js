...
const YrEmployeeAppraisalEditDialogComponent = (props) => {
...
managerEmpNO: _entity?.managerEmpNO,
...
competencyWeight: _entity?.competencyWeight,
        ...
        const result = await client.service("yrEmployeeAppraisal").patch(_entity._id, _data);
        props.onHide();
        props.alert({ type: "success", title: "Edit info", message: "Info yrEmployeeAppraisal updated successfully" });
    ...
    return (
        <Dialog header="Edit Yr Employee Appraisal" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max scalein animation-ease-in-out animation-duration-1000" footer={renderFooter()} resizable={false}>
            <div className="grid p-fluid overflow-y-auto"
            style={{ maxWidth: "55vw" }} role="yrEmployeeAppraisal-edit-dialog-component">
...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <Calendar id="startDate" value={_entity?.startDate ? new Date(_entity?.startDate) : null} onChange={ (e) => setValByKey("startDate", new Date(e.value))} showIcon showButtonBar  required  />
            </span>
            <small className="p-error">
...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <Calendar id="endDate" value={_entity?.endDate ? new Date(_entity?.endDate) : null} onChange={ (e) => setValByKey("endDate", new Date(e.value))} showIcon showButtonBar  required  />
            </span>
            <small className="p-error">
...
export default connect(mapState, mapDispatch)(YrEmployeeAppraisalEditDialogComponent);
