...
import seederData from "./yrEmployeeAppraisal.seeder.json";
...
const YrEmployeeAppraisalSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(YrEmployeeAppraisalSeederDialogComponent);
