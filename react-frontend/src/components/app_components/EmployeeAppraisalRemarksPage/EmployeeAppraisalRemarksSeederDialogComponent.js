...
import seederData from "./employeeAppraisalRemarks.seeder.json";
...
const EmployeeAppraisalRemarksSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(EmployeeAppraisalRemarksSeederDialogComponent);
