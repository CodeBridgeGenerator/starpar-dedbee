...
import seederData from "./yrEmployeeAppraisalReview.seeder.json";
...
const YrEmployeeAppraisalReviewSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(YrEmployeeAppraisalReviewSeederDialogComponent);
