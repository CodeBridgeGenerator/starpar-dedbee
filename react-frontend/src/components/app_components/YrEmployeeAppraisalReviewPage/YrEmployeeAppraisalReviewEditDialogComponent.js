...
const YrEmployeeAppraisalReviewEditDialogComponent = (props) => {
...
otherTraining: _entity?.otherTraining,
        ...
        const result = await client.service("yrEmployeeAppraisalReview").patch(_entity._id, _data);
        props.onHide();
        props.alert({ type: "success", title: "Edit info", message: "Info yrEmployeeAppraisalReview updated successfully" });
    ...
    return (
        <Dialog header="Edit Yr Employee Appraisal Review" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max scalein animation-ease-in-out animation-duration-1000" footer={renderFooter()} resizable={false}>
            <div className="grid p-fluid overflow-y-auto"
            style={{ maxWidth: "55vw" }} role="yrEmployeeAppraisalReview-edit-dialog-component">
...
export default connect(mapState, mapDispatch)(YrEmployeeAppraisalReviewEditDialogComponent);
