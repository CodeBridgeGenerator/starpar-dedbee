const { YrEmployeeAppraisal } = require("./yrEmployeeAppraisal.class");
const createModel = require("./yrEmployeeAppraisal.model");
const hooks = require("./yrEmployeeAppraisal.hooks");
...
module.exports = function (app) {
  ...
  app.use("/yrEmployeeAppraisal", new YrEmployeeAppraisal(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("yrEmployeeAppraisal");

  // Get the schema of the collections 
  app.get("/yrEmployeeAppraisalSchema", function (request, response) {
