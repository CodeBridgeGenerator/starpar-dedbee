const { Calibration } = require("./calibration.class");
const createModel = require("./calibration.model");
const hooks = require("./calibration.hooks");
...
module.exports = function (app) {
  ...
  app.use("/calibration", new Calibration(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("calibration");

  // Get the schema of the collections 
  app.get("/calibrationSchema", function (request, response) {
