const { EmployeeAppraisalReview } = require("./employeeAppraisalReview.class");
const createModel = require("./employeeAppraisalReview.model");
const hooks = require("./employeeAppraisalReview.hooks");
...
module.exports = function (app) {
  ...
  app.use("/employeeAppraisalReview", new EmployeeAppraisalReview(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("employeeAppraisalReview");

  // Get the schema of the collections 
  app.get("/employeeAppraisalReviewSchema", function (request, response) {
