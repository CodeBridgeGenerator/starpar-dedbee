const { MasterKra } = require("./masterKra.class");
const createModel = require("./masterKra.model");
const hooks = require("./masterKra.hooks");
...
module.exports = function (app) {
  ...
  app.use("/masterKra", new MasterKra(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("masterKra");

  // Get the schema of the collections 
  app.get("/masterKraSchema", function (request, response) {
