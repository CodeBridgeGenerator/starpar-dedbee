const { EmployeeKRAScore } = require("./employeeKRAScore.class");
const createModel = require("./employeeKRAScore.model");
const hooks = require("./employeeKRAScore.hooks");
...
module.exports = function (app) {
  ...
  app.use("/employeeKRAScore", new EmployeeKRAScore(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("employeeKRAScore");

  // Get the schema of the collections 
  app.get("/employeeKRAScoreSchema", function (request, response) {
