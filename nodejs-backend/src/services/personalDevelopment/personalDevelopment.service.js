const { PersonalDevelopment } = require("./personalDevelopment.class");
const createModel = require("./personalDevelopment.model");
const hooks = require("./personalDevelopment.hooks");
...
module.exports = function (app) {
  ...
  app.use("/personalDevelopment", new PersonalDevelopment(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("personalDevelopment");

  // Get the schema of the collections 
  app.get("/personalDevelopmentSchema", function (request, response) {
