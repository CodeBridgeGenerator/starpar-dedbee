const { MasterKpi } = require("./masterKpi.class");
const createModel = require("./masterKpi.model");
const hooks = require("./masterKpi.hooks");
...
module.exports = function (app) {
  ...
  app.use("/masterKpi", new MasterKpi(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("masterKpi");

  // Get the schema of the collections 
  app.get("/masterKpiSchema", function (request, response) {
