const { MasterCompetencies } = require("./masterCompetencies.class");
const createModel = require("./masterCompetencies.model");
const hooks = require("./masterCompetencies.hooks");
...
module.exports = function (app) {
  ...
  app.use("/masterCompetencies", new MasterCompetencies(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("masterCompetencies");

  // Get the schema of the collections 
  app.get("/masterCompetenciesSchema", function (request, response) {
