const { EmployeeCompetenciesscore } = require("./employeeCompetenciesscore.class");
const createModel = require("./employeeCompetenciesscore.model");
const hooks = require("./employeeCompetenciesscore.hooks");
...
module.exports = function (app) {
  ...
  app.use("/employeeCompetenciesscore", new EmployeeCompetenciesscore(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("employeeCompetenciesscore");

  // Get the schema of the collections 
  app.get("/employeeCompetenciesscoreSchema", function (request, response) {
