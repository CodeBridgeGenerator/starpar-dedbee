const { TotalScore } = require("./totalScore.class");
const createModel = require("./totalScore.model");
const hooks = require("./totalScore.hooks");
...
module.exports = function (app) {
  ...
  app.use("/totalScore", new TotalScore(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("totalScore");

  // Get the schema of the collections 
  app.get("/totalScoreSchema", function (request, response) {
