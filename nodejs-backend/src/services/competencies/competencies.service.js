const { Competencies } = require("./competencies.class");
const createModel = require("./competencies.model");
...
module.exports = function (app) {
  ...
  app.use("/competencies", new Competencies(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("competencies");

  // Get the schema of the collections 
  app.get("/competenciesSchema", function (request, response) {
