const { EmployeeTraining } = require("./employeeTraining.class");
const createModel = require("./employeeTraining.model");
const hooks = require("./employeeTraining.hooks");
...
module.exports = function (app) {
  ...
  app.use("/employeeTraining", new EmployeeTraining(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("employeeTraining");

  // Get the schema of the collections 
  app.get("/employeeTrainingSchema", function (request, response) {
