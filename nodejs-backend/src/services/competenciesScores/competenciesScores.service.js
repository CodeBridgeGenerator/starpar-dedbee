const { CompetenciesScores } = require("./competenciesScores.class");
const createModel = require("./competenciesScores.model");
const hooks = require("./competenciesScores.hooks");
...
module.exports = function (app) {
  ...
  app.use("/competenciesScores", new CompetenciesScores(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("competenciesScores");

  // Get the schema of the collections 
  app.get("/competenciesScoresSchema", function (request, response) {
