const { YrEmployeeTraining } = require("./yrEmployeeTraining.class");
const createModel = require("./yrEmployeeTraining.model");
const hooks = require("./yrEmployeeTraining.hooks");
...
module.exports = function (app) {
  ...
  app.use("/yrEmployeeTraining", new YrEmployeeTraining(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("yrEmployeeTraining");

  // Get the schema of the collections 
  app.get("/yrEmployeeTrainingSchema", function (request, response) {
