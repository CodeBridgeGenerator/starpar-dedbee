const { Kra } = require("./kra.class");
const createModel = require("./kra.model");
const hooks = require("./kra.hooks");
...
module.exports = function (app) {
  ...
  app.use("/kra", new Kra(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("kra");

  // Get the schema of the collections 
  app.get("/kraSchema", function (request, response) {
