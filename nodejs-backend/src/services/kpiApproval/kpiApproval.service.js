const { KpiApproval } = require("./kpiApproval.class");
const createModel = require("./kpiApproval.model");
const hooks = require("./kpiApproval.hooks");
...
module.exports = function (app) {
  ...
  app.use("/kpiApproval", new KpiApproval(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("kpiApproval");

  // Get the schema of the collections 
  app.get("/kpiApprovalSchema", function (request, response) {
