const { YrEmployeeKRAScore } = require("./yrEmployeeKRAScore.class");
const createModel = require("./yrEmployeeKRAScore.model");
const hooks = require("./yrEmployeeKRAScore.hooks");
...
module.exports = function (app) {
  ...
  app.use("/yrEmployeeKRAScore", new YrEmployeeKRAScore(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("yrEmployeeKRAScore");

  // Get the schema of the collections 
  app.get("/yrEmployeeKRAScoreSchema", function (request, response) {
