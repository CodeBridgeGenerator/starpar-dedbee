const { KraScores } = require("./kraScores.class");
const createModel = require("./kraScores.model");
const hooks = require("./kraScores.hooks");
...
module.exports = function (app) {
  ...
  app.use("/kraScores", new KraScores(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("kraScores");

  // Get the schema of the collections 
  app.get("/kraScoresSchema", function (request, response) {
