const { EmployeeKPIRateRange } = require("./employeeKPIRateRange.class");
const createModel = require("./employeeKPIRateRange.model");
const hooks = require("./employeeKPIRateRange.hooks");
...
module.exports = function (app) {
  ...
  app.use("/employeeKPIRateRange", new EmployeeKPIRateRange(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("employeeKPIRateRange");

  // Get the schema of the collections 
  app.get("/employeeKPIRateRangeSchema", function (request, response) {
