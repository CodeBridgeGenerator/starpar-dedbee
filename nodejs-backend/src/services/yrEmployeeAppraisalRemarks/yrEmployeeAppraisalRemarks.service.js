const { YrEmployeeAppraisalRemarks } = require("./yrEmployeeAppraisalRemarks.class");
const createModel = require("./yrEmployeeAppraisalRemarks.model");
const hooks = require("./yrEmployeeAppraisalRemarks.hooks");
...
module.exports = function (app) {
  ...
  app.use("/yrEmployeeAppraisalRemarks", new YrEmployeeAppraisalRemarks(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("yrEmployeeAppraisalRemarks");

  // Get the schema of the collections 
  app.get("/yrEmployeeAppraisalRemarksSchema", function (request, response) {
