const { EmployeeAppraisal } = require("./employeeAppraisal.class");
const createModel = require("./employeeAppraisal.model");
const hooks = require("./employeeAppraisal.hooks");
...
module.exports = function (app) {
  ...
  app.use("/employeeAppraisal", new EmployeeAppraisal(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("employeeAppraisal");

  // Get the schema of the collections 
  app.get("/employeeAppraisalSchema", function (request, response) {
