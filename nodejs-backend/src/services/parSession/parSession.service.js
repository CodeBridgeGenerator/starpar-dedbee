const { ParSession } = require("./parSession.class");
const createModel = require("./parSession.model");
const hooks = require("./parSession.hooks");
...
module.exports = function (app) {
  ...
  app.use("/parSession", new ParSession(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("parSession");

  // Get the schema of the collections 
  app.get("/parSessionSchema", function (request, response) {
