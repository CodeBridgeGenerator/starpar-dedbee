const { Appraisals } = require("./appraisals.class");
const createModel = require("./appraisals.model");
const hooks = require("./appraisals.hooks");
...
module.exports = function (app) {
  ...
  app.use("/appraisals", new Appraisals(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("appraisals");

  // Get the schema of the collections 
  app.get("/appraisalsSchema", function (request, response) {
