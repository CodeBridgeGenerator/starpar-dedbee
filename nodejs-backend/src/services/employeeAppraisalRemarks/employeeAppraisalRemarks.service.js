const { EmployeeAppraisalRemarks } = require("./employeeAppraisalRemarks.class");
const createModel = require("./employeeAppraisalRemarks.model");
const hooks = require("./employeeAppraisalRemarks.hooks");
...
module.exports = function (app) {
  ...
  app.use("/employeeAppraisalRemarks", new EmployeeAppraisalRemarks(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("employeeAppraisalRemarks");

  // Get the schema of the collections 
  app.get("/employeeAppraisalRemarksSchema", function (request, response) {
