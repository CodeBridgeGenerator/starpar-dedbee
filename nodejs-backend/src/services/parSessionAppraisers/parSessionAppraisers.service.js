const { ParSessionAppraisers } = require("./parSessionAppraisers.class");
const createModel = require("./parSessionAppraisers.model");
const hooks = require("./parSessionAppraisers.hooks");
...
module.exports = function (app) {
  ...
  app.use("/parSessionAppraisers", new ParSessionAppraisers(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("parSessionAppraisers");

  // Get the schema of the collections 
  app.get("/parSessionAppraisersSchema", function (request, response) {
