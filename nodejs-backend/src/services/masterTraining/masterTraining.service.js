const { MasterTraining } = require("./masterTraining.class");
const createModel = require("./masterTraining.model");
const hooks = require("./masterTraining.hooks");
...
module.exports = function (app) {
  ...
  app.use("/masterTraining", new MasterTraining(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("masterTraining");

  // Get the schema of the collections 
  app.get("/masterTrainingSchema", function (request, response) {
