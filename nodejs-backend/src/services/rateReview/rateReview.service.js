const { RateReview } = require("./rateReview.class");
const createModel = require("./rateReview.model");
const hooks = require("./rateReview.hooks");
...
module.exports = function (app) {
  ...
  app.use("/rateReview", new RateReview(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("rateReview");

  // Get the schema of the collections 
  app.get("/rateReviewSchema", function (request, response) {
