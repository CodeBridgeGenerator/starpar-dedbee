const { MasterBsc } = require("./masterBsc.class");
const createModel = require("./masterBsc.model");
const hooks = require("./masterBsc.hooks");
...
module.exports = function (app) {
  ...
  app.use("/masterBsc", new MasterBsc(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("masterBsc");

  // Get the schema of the collections 
  app.get("/masterBscSchema", function (request, response) {
