const { ScoreConfig } = require("./scoreConfig.class");
const createModel = require("./scoreConfig.model");
const hooks = require("./scoreConfig.hooks");
...
module.exports = function (app) {
  ...
  app.use("/scoreConfig", new ScoreConfig(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("scoreConfig");

  // Get the schema of the collections 
  app.get("/scoreConfigSchema", function (request, response) {
