const { YrEmployeeCompetenciesscore } = require("./yrEmployeeCompetenciesscore.class");
const createModel = require("./yrEmployeeCompetenciesscore.model");
const hooks = require("./yrEmployeeCompetenciesscore.hooks");
...
module.exports = function (app) {
  ...
  app.use("/yrEmployeeCompetenciesscore", new YrEmployeeCompetenciesscore(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("yrEmployeeCompetenciesscore");

  // Get the schema of the collections 
  app.get("/yrEmployeeCompetenciesscoreSchema", function (request, response) {
