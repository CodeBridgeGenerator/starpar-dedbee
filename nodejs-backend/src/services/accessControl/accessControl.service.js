const { AccessControl } = require("./accessControl.class");
const createModel = require("./accessControl.model");
...
module.exports = function (app) {
  ...
  app.use("/accessControl", new AccessControl(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("accessControl");

  // Get the schema of the collections 
  app.get("/accessControlSchema", function (request, response) {
