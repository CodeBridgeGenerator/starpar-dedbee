const { YrEmployeeKPIRateRange } = require("./yrEmployeeKPIRateRange.class");
const createModel = require("./yrEmployeeKPIRateRange.model");
const hooks = require("./yrEmployeeKPIRateRange.hooks");
...
module.exports = function (app) {
  ...
  app.use("/yrEmployeeKPIRateRange", new YrEmployeeKPIRateRange(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("yrEmployeeKPIRateRange");

  // Get the schema of the collections 
  app.get("/yrEmployeeKPIRateRangeSchema", function (request, response) {
