const { YrEmployeeAppraisalReview } = require("./yrEmployeeAppraisalReview.class");
const createModel = require("./yrEmployeeAppraisalReview.model");
const hooks = require("./yrEmployeeAppraisalReview.hooks");
...
module.exports = function (app) {
  ...
  app.use("/yrEmployeeAppraisalReview", new YrEmployeeAppraisalReview(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("yrEmployeeAppraisalReview");

  // Get the schema of the collections 
  app.get("/yrEmployeeAppraisalReviewSchema", function (request, response) {
